...
public class FloodgateHelper {
    ...
    protected boolean processFloodgateTasks(
        ...
        try {
            ...
            // Attribute key might not exist in newer Floodgate versions
        }
        ...
        // remove real Floodgate data handler (if it exists)
        // Newer Floodgate versions may use different handler names
        try {
            ...
            // Handler may have already been removed or doesn't exist in this version
        }
